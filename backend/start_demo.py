"""
CLI: start the real-time demo ticker.

Usage:
    python start_demo.py [route_id]   (default: R01)
"""
import sys
import httpx
...
url = f"{api_base}/demo/{ROUTE_ID}/start"

print(f"Starting demo for route {ROUTE_ID} ...")
try:
